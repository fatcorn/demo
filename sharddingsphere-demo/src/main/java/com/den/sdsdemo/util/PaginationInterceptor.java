...
public class PaginationInterceptor extends AbstractSqlParserHandler implements Interceptor {
     ...
     * @return ignore
     */
    public static String concatOrderBy(String originalSql, IMyPage<?> page, boolean orderBy) {
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        // 判断参数里是否有page对象
        IMyPage<?> page = null;
        if (paramObj instanceof IMyPage) {
            page = (IMyPage<?>) paramObj;
        } else if (paramObj instanceof Map) {
            for (Object arg : ((Map<?, ?>) paramObj).values()) {
                if (arg instanceof IMyPage) {
                    page = (IMyPage<?>) arg;
                    break;
                }
            }
     ...
     */
    protected void queryTotal(boolean overflowCurrent, String sql, MappedStatement mappedStatement, BoundSql boundSql, IMyPage<?> page, Connection connection) {
